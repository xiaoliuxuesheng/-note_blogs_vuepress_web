...
const DOMAIN_NAME = 'gitee.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  base: '/note_blogs_vuepress_web/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  // 主题配置
  themeConfig: {
    // 导航配置
    nav: [
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              {text: 'Flutter高级', link: '/flutter/height/'}
            ]
          },{
            text: '04.微信小程序',
            link: '/pages/de8e99/'

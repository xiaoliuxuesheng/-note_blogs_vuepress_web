...
**行和列的规划**：开启网格布局后，需要来规划行和列，主要应用的下面的两个grid容器属性；行和列规划后，子项会安装默认的顺序依次对应到行和列组成的单元格中，并且子项默认和单元格大小相同。所以行和列规划后需要指定单元格排列规则；
...
- 默认的排列方式
  ...
  > <img src="https://s1.ax1x.com/2023/06/07/pCigFoQ.png" alt="pCigFoQ.png" border="0" />
...
- 改变网格排列方向,默认值是row,是行排列,column 则是列排列
  ...
  > <img src="https://s1.ax1x.com/2023/06/07/pCigAij.png" alt="pCigAij.png" border="0" />
...
- 当存在剩余空间时,强制将剩余空间填满
  ...
  > <img src="https://s1.ax1x.com/2023/06/07/pCigVWn.png" alt="pCigVWn.png" border="0" />
...
- 如果想要从上到下的用元素填补剩余空间，可以如下:
  ...
  > <img src="https://s1.ax1x.com/2023/06/06/pCi3GuV.png" alt="pCi3GuV.png" border="0" />
